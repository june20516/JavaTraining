...
public class ExamMerge extends JFrame {
/*
	...
	public ExamMerge() {
		...
		lblAddSub1.setBounds(286, 47, 50, 20);
		lblAddSub1.setVisible(false);
		contentPane.add(lblAddSub1);
		
		lblAddSub2 = new JLabel();
		lblAddSub2.setVisible(false);
		lblAddSub2.setBounds(348, 47, 50, 20);
		contentPane.add(lblAddSub2);
		
		lblAddSub3 = new JLabel();
		lblAddSub3.setVisible(false);
		lblAddSub3.setBounds(408, 47, 50, 20);
		contentPane.add(lblAddSub3);
...
//		tableModel = new DefaultTableModel(rows,labels);
		...
		btnSubjectFix.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textAddSubject1.setVisible(false);
				textAddSubject2.setVisible(false);
				textAddSubject3.setVisible(false);
				lblAddSub1.setText(textAddSubject1.getText());
				lblAddSub2.setText(textAddSubject2.getText());
				lblAddSub3.setText(textAddSubject3.getText());
				lblAddSub1.setVisible(true);
				lblAddSub2.setVisible(true);
				lblAddSub3.setVisible(true);
